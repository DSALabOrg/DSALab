        ...
        if (f.endsWith(".txt") && f.startsWith("in")) {
            ...
            try {
                ...
                if (child.error || child.signal === 'SIGTERM') {
                    ...
                    fs.appendFileSync(ScriptReport, "Adjust time accordingly if 1000ms is not enough on line: 112 in evaluate.js\n\n");
            ...
            if (cotxt === proctxt) {
                ...
                fs.appendFileSync(path.join(Wrong, `TestCase-${testCaseNumber}.txt`), `https://github.com/nothuman2718/DSALab/blob/main/TestCases/Cycle2_PartA/Q${qn[1]}.md/#test-case-${testCaseNumber}`);
                fs.appendFileSync(ScriptReport, content);
            }
        }
    }
